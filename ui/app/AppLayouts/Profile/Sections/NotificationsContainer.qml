...
ScrollView {
    ...
    Item {
        ...
        height: sectionHeadlineNotifications.height * 3 + column.height + Style.current.smallPadding * 3 + Style.current.padding * 2 + Style.current.bigPadding * 4 + column2.height + column3.height + column4.height + 200 + column5.height
